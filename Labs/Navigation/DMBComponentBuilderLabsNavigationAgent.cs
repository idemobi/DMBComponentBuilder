...
public static class DMBComponentBuilderLabsNavigationAgent
{
            ...
            .AddItems(
                ...
                ActionItemFactory.Group("Components", IconStruct.Bootstrap("bi-ui-checks-grid"))
                    .AddItems(
                        ...
                        CreateAction("Conversation", "Index", "Conversation", "bi-chat-dots"),
                        ...
                        CreateAction("ChartJs", "Index", "ChartJs", "bi-bar-chart-line"),
            ...
            .Add(
                ...
                ActionItemFactory.Group("Components", IconStruct.Bootstrap("bi-ui-checks-grid"))
                    .AddItems(
                        ...
                        CreateAction("Conversation", "Index", "Conversation", "bi-chat-dots", currentController, currentAction),
                        ...
                        CreateAction("ChartJs", "Index", "ChartJs", "bi-bar-chart-line", currentController, currentAction),
    ...
    private static IconStruct ResolveIndexIcon(string? currentController)
    {
        return currentController switch
        {
            ...
            "ChartJs" => IconStruct.Bootstrap("bi-bar-chart-line"),
