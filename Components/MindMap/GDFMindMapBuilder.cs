...
// DMBComponentBuilder.csproj GDFMindMapBuilder.cs create at 2026/05/21
...
namespace DMBComponentBuilder
{
        ...
        ICanUseCustomClasses
    {
        ...
        private void WriteBranch(TextWriter writer, HtmlEncoder encoder, GDFMindMapNode node, string path, int depth, string side)
        {
